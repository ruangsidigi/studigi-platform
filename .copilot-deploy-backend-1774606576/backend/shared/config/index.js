...
const schema = Joi.object({
  ...
  ALLOW_ADMIN_PAYMENT_CONFIRM: Joi.boolean().truthy('true').falsy('false').optional(),
...
const allowAdminPaymentConfirm =
  env.ALLOW_ADMIN_PAYMENT_CONFIRM !== undefined
    ? Boolean(env.ALLOW_ADMIN_PAYMENT_CONFIRM)
    : nodeEnv !== 'production';

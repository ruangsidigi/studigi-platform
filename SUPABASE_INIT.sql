...
DROP TABLE IF EXISTS tryout_answers CASCADE;
...
CREATE INDEX idx_sessions_user ON tryout_sessions(user_id);
CREATE INDEX idx_sessions_package ON tryout_sessions(package_id);
CREATE INDEX idx_answers_session ON tryout_answers(session_id);
CREATE INDEX idx_answers_question ON tryout_answers(question_id);

-- Step 2: Insert admin user (password: admin123)
INSERT INTO users (email, password, name, role) 
VALUES ('admin@skdcpns.com', '$2a$10$90NDlDqc0g5bC/aqwWZXq.KowOdoSgkm/dc.ymLSeA1k73bwX1cKi', 'Admin CPNS', 'admin');

    ...
    return (
      <div className="mx-auto max-w-6xl space-y-5 p-4 sm:p-6">
        <div className="flex flex-wrap items-center justify-between gap-3 rounded-2xl border border-slate-200 bg-white p-5">
          ...
          <button
            type="button"
            className="w-full rounded-xl border border-slate-200 px-4 py-2 text-sm font-medium text-slate-700 hover:bg-slate-50 sm:w-auto"
            onClick={() => navigate(-1)}
          >
            Kembali
          </button>
            ...
            <div className="space-y-3">
              {bundleMaterials.map((material) => (
                <div key={material.id} className="flex flex-wrap items-center justify-between gap-3 rounded-xl border border-slate-200 p-3">
                  ...
                  <button
                    type="button"
                    className="w-full rounded-xl bg-[var(--header-color,#0f5132)] px-4 py-2 text-sm font-semibold text-white hover:opacity-90 sm:w-auto"
